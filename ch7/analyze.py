"""The analyze module users the Flesh-Kincaid readability test to analyze
text and produce a reeadability score. This score is then converted into a
grade-based readability category.

"""

def count_syllables(words):
    """This function takes a list of words and returns a total count of
    syllables across all words in the list.
    """
    count = 0
...
def count_syllables_in_word(word):
    ...
    of syllables. Note this function is a heuristic and may not be 100%
    accurate.
    """
    count = 0
    ...
    if (processed_word[-1]).lower() in 'e':
    ...
    if (processed_word[-1]).lower() in 'y':
        count += 1
...
def output_results(score):
    """This function takes a Flesh-Kincaid score and prints the corresponding
    reading level.
    """
    if score >= 90.0:
...
def compute_readability(text):
    """This function takes a test string of any length and prints out a
